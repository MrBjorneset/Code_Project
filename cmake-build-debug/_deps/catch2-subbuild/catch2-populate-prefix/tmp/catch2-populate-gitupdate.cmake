...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref "v2.13.8"
  WORKING_DIRECTORY "C:/Kode/GitHub/C++/Code_Project/cmake-build-debug/_deps/catch2-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Kode/GitHub/C++/Code_Project/cmake-build-debug/_deps/catch2-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Kode/GitHub/C++/Code_Project/cmake-build-debug/_deps/catch2-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
